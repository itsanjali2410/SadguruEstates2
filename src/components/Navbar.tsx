        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 text-white flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-blue-600 mr-2">
              ...
              <span className="font-bold text-2xl tracking-tight">Sadguru<span className="text-blue-600">Estate</span></span>
            </Link>
          </div>
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              type="button"
              className="bg-neutral-700 inline-flex items-center justify-center p-2 rounded-md text-neutral-400 hover:text-white hover:bg-neutral-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-800 focus:ring-white"
